define('custom:handlers/c-rechnung/mass-download-pdf-zip', [], function () {
    ...
    Handler.prototype.actionDownloadPdfZip = function (data) {
        ...
        if (!Array.isArray(ids) || !ids.length) {
            Espo.Ui.warning('Bitte zuerst Rechnungen auswählen.');
            return;
        }
        ...
        const url = basePath + 'api/v1/CRechnung/action/downloadPdfZip';
