define('custom:views/c-ausgleich/record/edit-small', ['views/record/edit-small'], function (Dep) {
    return Dep.extend({
        ...
        _fillFromZahlungAndDocument: async function (entityType, documentId) {
            ...
            try {
                ...
                console.error('[CAusgleich/edit-small] Autofill error', e);
        ...
        _updateZahlungPartner: function (zahlungId, data) {
            ...
            Espo.Ajax.putRequest('CZahlung/' + zahlungId, data).catch((e) => {
                console.warn('[CAusgleich/edit-small] Zahlung partner update skipped', e);
            });
        }
    });
});