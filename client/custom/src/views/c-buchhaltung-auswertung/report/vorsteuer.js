// Отчёт Vorsteuer.
// Что это: Phase-2-Bericht по Vorsteuer-Buchungen из Eingangsrechnungen.

define('custom:views/c-buchhaltung-auswertung/report/vorsteuer', [], function () {
    return {
                ...
                <div class="panel panel-default kb-auswertung-summary">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="well">
                                    <div><strong>Anzahl Vorsteuer-Buchungen</strong></div>
                                    <div class="kb-kpi-anzahl" style="font-size: 22px;">0</div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="well">
                                    <div><strong>Gesamt Vorsteuer</strong></div>
                            ...
                            <div class="col-sm-4">
                                <div class="well">
                                    ...
                                    <div class="kb-kpi-konto" style="font-size: 22px;">1406 / 1401</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-default kb-auswertung-tabs">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="kb-tab-panel" data-tab-panel="gf">
                            ...
                            <p>Überblick über Vorsteuer aus festgeschriebenen Eingangsrechnungen.</p>
                        ...
                        <div class="kb-tab-panel hidden" data-tab-panel="buha">
                            ...
                            <p>Detailsicht auf Vorsteuer-Buchungen aus dem Buchungsjournal.</p>
                ...
                collection.fetch().then(() => {
                    const list = (collection.models || [])
                        ...
                        .filter(item =>
                            ...
                            (
                                String(item.kontoNummer || '') === '1406' ||
                                String(item.kontoNummer || '') === '1401'
                            )
                        );
                    ...
                    console.error('[Vorsteuer] load failed', err);
                    view.notify('Fehler beim Laden des Vorsteuer-Berichts', 'error');
                });
            });
        },
        ...
        render(view, list) {
            ...
            if (!list.length) {
                $tbodyGf.html('<tr><td colspan="5" class="text-muted">Keine Vorsteuer-Buchungen gefunden.</td></tr>');
                $tbodyBuha.html('<tr><td colspan="9" class="text-muted">Keine Vorsteuer-Buchungen gefunden.</td></tr>');
